...
answer2 = np.mean(X.dot(norm_eq_weights))
...
get_ipython().run_cell_magic('time', '', 'stoch_grad_desc_weights, stoch_errors_by_iter = \\\nstochastic_gradient_descent(X,y,np.zeros(X.shape[1]),\n                                max_iter=10**5)')
